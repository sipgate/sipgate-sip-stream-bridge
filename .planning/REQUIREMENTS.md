...
- [ ] **OPTS-01**: Go-Registrar sendet alle 30s einen SIP OPTIONS-Request an sipgate zur Liveness-Prüfung
...
- [ ] **OPTS-05**: OPTIONS-Interval ist via `SIP_OPTIONS_INTERVAL` env-var konfigurierbar (Default: 30s)
